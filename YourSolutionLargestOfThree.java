 ...
 * It can be way more compact.. WAY MORE
 * 1: Lay off the \n, println already does a \n
 * 2: Close your imput stream.. 
 * 3: Use I\O when absolutely nessecary 
 * 4: Overcommenting can be a issue, your code should speak for it's self. 
 */

import java.util.Scanner;

public class YourSolutionLargestOfThree {
